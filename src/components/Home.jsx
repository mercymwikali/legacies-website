        ...
        <div id="/" className="min-h-screen mt-0 ">
            <div className="flex flex-col md:flex-row justify-between ">
                <div className='px-8 flex flex-col pt-16'>
                    ...
                    <Button className="group flex justify-center w-full md:w-[40%]  px-4 bg-red hover:bg-transparent hover:text-red hover:border-blue-500 border-2 shadow-md border-red text-white font-bold py-3 rounded-full transition-all duration-300 mt-5">
                        Discover More
                        <MdKeyboardDoubleArrowRight size={25} className='-rotate-90 duration-100  ease-in group-hover:rotate-0' />
                    </Button>
                </div>
                <div className='md:pl-8 overflow-hidden'>
