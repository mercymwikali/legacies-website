    ...
    return (
        <section id='/services' className=' mx-auto text-center bg-slate-100 p-8'>
            <div className="py-4 max-w-3xl mx-auto tracking-normal">
                ...
                <p className='text-slate-500 text-normal py-3'>We provide advisory services for the seamless integration of advanced technologies at clients' locations. This includes implementing new technologies based on clients' specifications, upgrading and enhancing existing facilities by seamlessly integrating cutting-edge technology with the current systems. Our comprehensive consulting services encompass:</p>
            </div>
            ...
            <div className="card border-x-2 border-blue cursor-pointer">
                ...
                <div className="card border-x-2 border-blue cursor-pointer">
                    <div className="p-2 flex flex-col">
                        ...
                        <p className='text-slate-500 text-normal pt-2'>Legacies Systems & Solutions Ltd empowers clients to discover, develop, and deploy tailored solutions that effectively address their evolving business needs.</p>
                    </div>
                </div>
                <div className="card border-x-2 border-blue cursor-pointer">
                    <div className="p-2 flex flex-col">
                        ...
                        <p className='text-slate-500 text-normal pt-2'>With our expertise and experience, we excel in managing essential infrastructure and applications for various industries. Our Managed Services cover all IT operations, offering clients control and flexibility while reducing costs and complexities.</p>
                    </div>
                </div>
